...
public class ErrorsAnalyzer implements Analyzer {
    ...
    public ErrorsAnalyzer(boolean isProductionEnv, LambdaLogger logger) {
    ...
    protected void analyzeErrorCode(
